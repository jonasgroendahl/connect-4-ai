...
export const twoInALineAiAlphaBeta = (
  board: Board,
  depth: number,
  ...
  if (isMaximizingPlayer) {
    ...
    for (const [x, y] of moves) {
      ...
      const score = twoInALineAiAlphaBeta(board, depth - 1, false, alpha, beta);
    ...
    for (const [x, y] of moves) {
      ...
      const score = twoInALineAiAlphaBeta(board, depth - 1, true, alpha, beta);
